...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "payload"."enum_posts_category" AS ENUM('insight', 'advisory', 'compliance', 'resilience', 'news');
  CREATE TYPE "payload"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "payload"."enum__posts_v_version_category" AS ENUM('insight', 'advisory', 'compliance', 'resilience', 'news');
  ...
  CREATE TABLE "payload"."posts" (
  	...
  	"content" jsonb,
  	"category" "payload"."enum_posts_category" DEFAULT 'insight',
  	"author" varchar DEFAULT 'Atlantic Fortis',
  ...
  CREATE TABLE "payload"."_posts_v" (
  	...
  	"version_category" "payload"."enum__posts_v_version_category" DEFAULT 'insight',
  	"version_author" varchar DEFAULT 'Atlantic Fortis',
